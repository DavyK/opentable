...
urlpatterns = patterns('',
    ...
    url(r'^archiveSummaryList/(?P<s_month>\w+)/(?P<s_year>\d+)/$', views.archive_list_summaries, name='archive_list_summaries'),
    url(r'^characterSummaryList/(?P<character_id>\d+)/$', views.character_list_summaries, name='character_list_summaries'),
